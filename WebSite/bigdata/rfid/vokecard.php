<?php
    ...
    // http://localhost:8888/bigdata/rfid/vokecard.php?KEY=1234567890
    // http://iot.arduino.org.tw:8888/bigdata/rfid/vokecard.php?KEY=1234567890
    ...
    //select * from rfidlist where rfidkey = '1234567890' and activate in (0,1)
    ...
    if ($num >= 1) {
        ...
        $qry = "update rfidlist set activate = 9 , systime = '%s',IP = '%s' where rfidkey = '%s' and activate in (0,1)";
