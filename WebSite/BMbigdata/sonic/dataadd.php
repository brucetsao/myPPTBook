...
//	mysqli_select_db($link, "ncnuiot") ;
	...
	$temp1=$_GET["D"];		//取得POST參數 : 距離值

	$sysdt = getdatetime() ;
//	$ddt = getdataorder() ;

	//http://iot.arduino.org.tw:8888/bigdata/sonic/dataadd.php?MAC=AABBCCDDEEFF&D=34.45
	
	//INSERT INTO `sonic` (`id`, `MAC`, `crtdatetime`, `distance`, `systime`) VALUES (NULL, 'AABBCCDDEEFF', CURRENT_TIMESTAMP, '45.56', '20250417222101');
