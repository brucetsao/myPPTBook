...
String strGet = "/bigdata/rfid/disact.php"; // 請求行的開頭（未直接使用）
...
/*
 //http://iot.arduino.org.tw:8888/bigdata/rfid/disact.php?KEY=1938332656&MAC=B8D61A68DAFC
  ...
  應用程式路徑：/bigdata/rfid/disact.php?KEY=1938332656&MAC=B8D61A68DAFC（伺服器上的 PHP 程式，用來接收並處理資料）。
...
/*
  ...
  */
  ...
  if (String(card) == cardNumber && String(result) == "Deactivated") 
  {
    msg="Deactivated" ;   //卡號存在但未啟動，讓此卡號啟動
    return true;
  }
