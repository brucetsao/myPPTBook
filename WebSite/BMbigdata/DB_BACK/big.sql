...
CREATE TABLE `globalweather` (
  ...
  `sdatetime` datetime NOT NULL COMMENT '資料時間',
  `timezone` char(10) COLLATE utf8_unicode_ci NOT NULL COMMENT '時區',
  `lat` char(16) COLLATE utf8_unicode_ci NOT NULL COMMENT '緯度',
  `lon` char(16) COLLATE utf8_unicode_ci NOT NULL COMMENT '經度',
  `country` char(10) COLLATE utf8_unicode_ci NOT NULL COMMENT '國家',
  `wdir` int(11) NOT NULL COMMENT '風向',
...
CREATE TABLE `gps` (
  `id` int(11) NOT NULL,
  `mac` varchar(12) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `hauser` (
  ...
  `username` char(24) COLLATE utf8_unicode_ci NOT NULL COMMENT '使用者名稱',
...
CREATE TABLE `login` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `account` varchar(16) COLLATE utf8_unicode_ci NOT NULL COMMENT '登錄帳號',
  `pwd` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '密碼',
  `ipaddr` varchar(15) COLLATE utf8_unicode_ci NOT NULL COMMENT '登陸ip address',
  ...
  `accountid` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT '客戶號碼',
...
CREATE TABLE `memberdiploma` (
  ...
  `name` char(200) COLLATE utf8_unicode_ci NOT NULL COMMENT '學校名稱',
  ...
  `strdate` char(6) COLLATE utf8_unicode_ci NOT NULL COMMENT '開始年月',
  `strend` char(6) COLLATE utf8_unicode_ci NOT NULL COMMENT '結束年月',
  `crtdatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '資料創立時間'
...
CREATE TABLE `members` (
  ...
  `name` char(30) COLLATE utf8_unicode_ci NOT NULL COMMENT '會員姓名',
  `ename` char(60) CHARACTER SET ascii DEFAULT NULL COMMENT '英文名字',
  `address` char(120) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '會員地址',
...
CREATE TABLE `ow_citylist` (
  ...
  `sname` varchar(60) COLLATE utf8_unicode_ci NOT NULL COMMENT '城市名稱',
  `country` char(16) COLLATE utf8_unicode_ci NOT NULL COMMENT '國碼',
  `state` char(16) COLLATE utf8_unicode_ci NOT NULL COMMENT '省、洲',
...
CREATE TABLE `ow_curent` (
  ...
  `sitename` varchar(60) COLLATE utf8_unicode_ci NOT NULL COMMENT '站台名稱',
...
CREATE TABLE `pmbox` (
  ...
  `boxname` char(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '裝置名稱',
  `crtdatatime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '系統建立時間',
  `updatetime` char(14) CHARACTER SET ascii NOT NULL COMMENT '使用者更新時間'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `pmboxsensor` (
  ...
  `sensorname` char(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '感測器名稱',
  `crtdatatime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '系統建立時間',
