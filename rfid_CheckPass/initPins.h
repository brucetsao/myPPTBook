...
void Relayon() ; //控制板上Relay Modules打開
void Relayoff() ;//控制板上Relay Modules關閉  
...
void initGPIO() //設定使用之所有GPIO腳位
{
  ...
  pinMode(RelayPin,OUTPUT) ; //設定Relay Modules輸出高低電位
