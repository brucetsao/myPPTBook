...
CREATE TABLE `bmp` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `MAC` varchar(12) NOT NULL COMMENT '裝置MAC值',
  `IP` char(20) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL COMMENT '連線網址',
  `crtdatetime` timestamp NOT NULL DEFAULT current_timestamp() COMMENT '資料輸入時間',
  `systime` varchar(14) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL COMMENT '使用者更新時間',
  `pressure` double NOT NULL COMMENT '大氣壓力值(hPa)',
...
-- 資料表結構 `dhtdata1`
--
-- 讀取資料表 big.dhtdata1 的結構時出現錯誤： #1932 - Table &#039;big.dhtdata1&#039; doesn&#039;t exist in engine
...
-- 資料表結構 `luxday`
--
-- 讀取資料表 big.luxday 的結構時出現錯誤： #1932 - Table &#039;big.luxday&#039; doesn&#039;t exist in engine
...
CREATE TABLE `pmdevice` (
  ...
  `sysdatetime` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT '資料更新時間',
  `mac` varchar(12) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL COMMENT '裝置mac',
  `deviceid` varchar(12) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL COMMENT '裝置號碼',
  ...
  `areaid` varchar(16) CHARACTER SET ascii COLLATE ascii_general_ci DEFAULT NULL COMMENT '偵測區域'
...
CREATE TABLE `sensortype` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `sid` varchar(2) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL COMMENT '感測器代碼',
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL COMMENT '主鍵',
  `account` varchar(10) NOT NULL DEFAULT '' COMMENT '登錄帳號',
  `password` varchar(10) NOT NULL DEFAULT '' COMMENT '登錄密碼',
